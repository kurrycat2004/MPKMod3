package io.github.kurrycat.mpkmod.transformer.glsc;
...
public class GLStateCacheRedirector implements Transformer {
    ...
    private static final ILogger LOGGER = Transformer.LOGGER.createSubLogger(GLStateCacheRedirector.class.getSimpleName());
