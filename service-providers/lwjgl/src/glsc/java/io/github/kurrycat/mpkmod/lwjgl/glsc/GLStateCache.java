...
public final class GLStateCache {
    ...
    public static int glGetInteger(int pname) {
        return switch (pname) {
            case GLC11.GL_BLEND_SRC -> blendSrc;
            case GLC11.GL_BLEND_DST -> blendDst;
            case GLC11.GL_SHADE_MODEL -> shadeModel;
            case GLC15.GL_ARRAY_BUFFER_BINDING -> arrayBufferBinding;
            case GLC15.GL_ELEMENT_ARRAY_BUFFER_BINDING -> elementArrayBufferBinding;
            case GLC20.GL_CURRENT_PROGRAM -> currentProgram;
            case GLC30.GL_VERTEX_ARRAY_BINDING -> vertexArrayBinding;
