...
public final class FileUtil {
    ...
    public static Path findPath(List<Path> rootPaths, String file) {
    ...
    public static FileSystem getOrCreateJarFileSystem(Path path) throws IOException {
    ...
    public static void tryCloseJar(Path path) {
        FileSystem fileSystem = FileUtil.getJarFileSystem(path);
